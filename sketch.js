...
spaceImage = loadImage("Images/Space.jpg")
 ...
 alienImage = loadImage("Images/aliensaved.png");
  ...
  alienSaved=loadImage("Images/aliensaved.png");
}
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   // spawnAliens();
    ...
    alien=createSprite(displayWidth,displayHeight/2);
    alien.addImage("aliens",alienSaved);
    alien.velocityX=-5;
    alien.depth=spaceship.depth;
    score = score + Math.round(getFrameRate()/60);
    space.velocityX = -(6 + 6*score/100);
